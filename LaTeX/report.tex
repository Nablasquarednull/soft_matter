...
A considerable ammount of attention has been driven toward the physical manipulation of polymers that are not large to be on termodynamic equilibrium, the extension of a polymer by the stretching of a canteliver is a recurrent example \cite{Manca2012} in this regard, an expression for the force - extension relationship has been found by \cite{extensionRef}.  
